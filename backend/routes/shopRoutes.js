...
import { createShop, getShops, getShopById, importShops, updateShopSettings, updateShop } from '../controllers/shopController.js';
...
router.route('/:id').get(protect, getShopById).put(protect, authorize('superadmin'), updateShop);
